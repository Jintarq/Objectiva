...
export default function Sidebar({ pageName = "overview" }) {
  ...
  return (
    <div className='flex flex-col p-10 border-r border-black font-semibold border-solid h-screen min-w-[15%] bg-[#20212C]'>
      <div className='mb-20'>
        <h1 className='lg:text-4xl md:text-3xl text-xl text-slate-200'>
          Objectiva
        </h1>
      </div>
      <div className='flex'>
        <ul className='flex flex-col items-start'>
          ...
          <div className='border-t pt-8  border-black'>
            ...
            <Link to='/addtheme'>
              ...
              >
                <img src={Plus} className='lg:w-10 w-8' alt='Plus logo' />
                <p className='lg:block hidden'>Manage theme</p>
              </li>
            </Link>
          </div>
        </ul>
